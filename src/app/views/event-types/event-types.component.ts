...
import { EventTypesDialogComponent } from './event-types.dialog';
...
export class EventTypesComponent implements AfterViewInit {
  private readonly resource = 'eventTypes';
  ...
  load(): void {
    ...
    this.api
      ...
      .subscribe({
        ...
        error: (error) => {
          console.error(
            '[EventTypes] Error cargando registros:',
            error,
          );
          ...
          this.showMessage(
            'No fue posible cargar los tipos de eventos.',
  ...
  openDialog(row?: CatalogItem): void {
    const ref = this.dialog.open(EventTypesDialogComponent, {
      width: '560px',
      maxWidth: '95vw',
      disableClose: true,
      ...
      this.api
        ...
        .subscribe({
          next: () => {
            ...
            this.showMessage(
              'El tipo de evento fue eliminado correctamente.',
              'Operación realizada',
              'check_circle',
            );
          },
          ...
          error: (error) => {
            console.error(
              '[EventTypes] Error eliminando registro:',
              error,
            );
            ...
            this.showMessage(
              this.getErrorMessage(
                error,
                'No fue posible eliminar el tipo de evento.',
              ),
  ...
  restore(row: CatalogItem): void {
    ...
    const ref = this.dialog.open(ConfirmDialogYesNoComponent, {
      ...
      backdropClass: 'app-backdrop',
      data: {
        title: 'Restaurar tipo de evento',
        message:
      ...
      this.api
        ...
        .subscribe({
          next: () => {
            ...
            this.showMessage(
              'El tipo de evento fue restaurado correctamente.',
              'Operación realizada',
              'check_circle',
            );
          },
          ...
          error: (error) => {
            console.error(
              '[EventTypes] Error restaurando registro:',
              error,
            );
            ...
            this.showMessage(
              this.getErrorMessage(
                error,
                'No fue posible restaurar el tipo de evento.',
              ),
